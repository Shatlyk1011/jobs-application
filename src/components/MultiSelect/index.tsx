                ...
                <div className="flex w-full items-center justify-between">
                  <div
                    className={cn(
                      ...
                      singleLine ? "multiselect-singleline-scroll overflow-x-hidden" : "flex-wrap",
                        ...
                        return (
                          ...
                          >
                            ...
                            <div
                              ...
                              className="p-0.2 -m-0.5 ml-2 h-4 w-4 cursor-pointer rounded-sm hover:bg-white/20 focus:ring-1 focus:ring-white/50 focus:outline-none"
                            >
                        ...
                        >
                          <div
                            className={cn(
                              ...
                              isSelected ? "bg-primary text-primary-foreground" : "opacity-80 [&_svg]:invisible",
                            )}
                            aria-hidden="true"
                          >

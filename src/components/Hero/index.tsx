...
export default function Hero() {
  return (
    <div className="mx-auto grid h-max w-full max-w-5xl grid-cols-2 max-lg:grid-cols-1 gap-4.5">
      ...
      <Link href={"/mentors"} className="col-span-2 max-lg:col-span-1 h-full min-h-[220px] max-sm:min-h-[200px]">
